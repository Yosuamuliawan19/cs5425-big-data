...
//        highways.filter("array_contains(nd._ref,9394381621)").show();
//        oneway.filter("array_contains(nd._ref, 9394381621)").show();
//        biway.filter("array_contains(nd._ref, 9394381621)").show();
        ...
        oneway.coalesce(1).filter("from = 9394381621").show();
        biway_forward.coalesce(1).filter("from = 9394381621").show();
        biway_backward.coalesce(1).filter("from = 9394381621").show();
        ...
        all_edges.coalesce(1).filter("from = 9394381621").show();
        oneway.union(biway_forward).union(biway_backward).coalesce(1).filter("from = 9394381621").show();
        ...
        String INTER_OSM_OUTPUT ="TNTER_" +  OSM_OUTPUT;
...
//        System.out.println(adj_list.coalesce(1).filter("from = 9394381621").first().getString(0));
